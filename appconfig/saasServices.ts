...
import { MuleSoftServicesController } from "../modules/muleSoftServices/muleSoftServices.controller";

let instance = 'SaaS'
const muleSoftServicesController = new MuleSoftServicesController();
export class saasServices {
    sendItemAPIExecution = (newObsoletepartDetails, muleheaderDetails) => {
        ...
        return axios.post(sendItemUrl, encryptPayloadToMule, muleheaderDetails); 
    }
}